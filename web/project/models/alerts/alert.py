...
import datetime
import requests
import project.models.alerts.constants as AlertConstants
    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                "to": self.user_email,
                "subject": "Price limit reach for {}".format(self.item.name),
                "text": "We ve found a deal! ({}). To navigate to the alert, visit {}".format(self.item.url, "http://priceing.xxx.com/alerts/{}".format(self.id))
            }
        )
