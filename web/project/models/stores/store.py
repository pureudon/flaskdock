...
import project.models.stores.constants as StoreConstants
import project.models.stores.errors as StoreErrors
...
class Store(object):
    ...
    def get_by_url_prefix(cls, url_prefix):
        """
        http://www.ejfq.com -> http://www.ejfq.com
        :param url_prefix:
        :return:
        """
    ...
    def find_by_url(cls, url):
        """
        Return a store from a url like "http://www.ejfq.com/item/xxxxx.html"
        :param url: The items's URL
        :return: a Store, or raises a StoreNot FoundException if no store match the URL
        """
